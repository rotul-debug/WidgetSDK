System.register(["tslib", "@angular/core", "./settings-subcomponent"], function (exports_1, context_1) {
    "use strict";
    var tslib_1, core_1, settings_subcomponent_1, SettingsSubcomponentMonitor;
    ...
    return {
        ...
        execute: function () {
            SettingsSubcomponentMonitor = class SettingsSubcomponentMonitor extends settings_subcomponent_1.SettingsSubcomponent {
                constructor() {
                    super();
                    this.onChange = new core_1.EventEmitter();
                    this.programData = [];
                    this.transactionData = [];
                    this.displayStyles = ["Grid", "List" /*"Graph"*/];
                }
                ngOnInit() {
                    if (this.widgetSettingsContext) {
                        ...
                        this.monitorData = JSON.parse(monitorData);
            ...
            ], SettingsSubcomponentMonitor.prototype, "widgetSettingsContext", void 0);
            tslib_1.__decorate([
                core_1.Input(),
                tslib_1.__metadata("design:type", String)
            ], SettingsSubcomponentMonitor.prototype, "label", void 0);
            tslib_1.__decorate([
                core_1.Output(),
                tslib_1.__metadata("design:type", core_1.EventEmitter)
            ], SettingsSubcomponentMonitor.prototype, "onChange", void 0);
            tslib_1.__decorate([
                core_1.Input(),
                tslib_1.__metadata("design:type", Object)
            ], SettingsSubcomponentMonitor.prototype, "monitorData", void 0);
            SettingsSubcomponentMonitor = tslib_1.__decorate([
                core_1.Component({
...
-->
  `,
            ...
            exports_1("SettingsSubcomponentMonitor", SettingsSubcomponentMonitor);
        }
    };
});
//# sourceMappingURL=settings-subcomponent-monitor.js.map